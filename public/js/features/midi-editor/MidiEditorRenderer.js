  ...
  class MidiEditorRenderer {
        ...
        try {
          if (ch.channel !== 9) {
            ...
            const effectiveProgram =
              this.modal.channelRouting.has(ch.channel) && routedGm != null ? routedGm : ch.program;
            ...
            if (showButtons) {
              ...
              if (
                ...
                WindInstrumentDatabase.isWindInstrument(effectiveProgram)
              ) {
          ...
          /* ignore — buttons will be added by _refreshStringInstrumentChannels */
        }
    ...
    updateInstrumentSelector() {
      ...
      if (this.modal.activeChannels.size === 0) {
        ...
        if (instrumentLabel) {
          instrumentLabel.textContent = this.modal.t('midiEditor.multipleChannels', {
