// public/js/views/components/auto-assign/AutoAssignHelpers.js
// Utility / helper methods for AutoAssignModal
(function() {
'use strict';

const AutoAssignHelpers = {};

/**
 * Safely format info field (can be string or array)
 */
AutoAssignHelpers.formatInfo = function(info) {
  if (!info) return '';
 ...
 */
AutoAssignHelpers.getGmProgramName = function(program) {
 ...
 */
AutoAssignHelpers.midiNoteToName = function(note) {
 ...
 */
AutoAssignHelpers.isBlackKey = function(note) {
  const n = note % 12;
 ...
 */
AutoAssignHelpers.isNoteInInstrumentRange = function(note, instrument) {
 ...
 */
AutoAssignHelpers.calculateAdaptationResult = function(channel, strategy) {
 ...
 */
AutoAssignHelpers.formatInstrumentInfo = function(instrument, compat) {
 ...
 */
AutoAssignHelpers.getScoreStars = function(score) {
 ...
 */
AutoAssignHelpers.getScoreLabel = function(score) {
  const _t = (key, params) => typeof i18n !== 'undefined' ? i18n.t(key, params) : key;
 ...
 */
AutoAssignHelpers.getPolyphonyLabel = function(polyphony) {
  const _t = (key, params) => typeof i18n !== 'undefined' ? i18n.t(key, params) : key;
 ...
 */
AutoAssignHelpers.getTypeIcon = function(type) {
  const icons = {
    drums: '\uD83E\uDD41',
    bass: '\uD83C\uDFB8',
    melody: '\uD83C\uDFB9',
 ...
 */
AutoAssignHelpers.getOtherChannelsUsingInstrument = function(instrumentId, excludeChannel) {
  const others = [];
...
if (typeof window !== 'undefined') window.AutoAssignHelpers = AutoAssignHelpers;
})();
